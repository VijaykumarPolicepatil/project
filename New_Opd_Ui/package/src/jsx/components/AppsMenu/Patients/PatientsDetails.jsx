...
import icon from "../../../../../src/assets/images/icons8-history-48.png";
//notes
                      ...
                      <div className="row">
                        <div className="row mb-2">
                          <div className="col-6">
                            ...
                            <span>{formData.spouseName1}</span>
                          </div>
                          <div className="col-6">
                                    ...
                                    <div className="d-flex justify-content-end align-items-center">
                                      ...
                                      <div className="img_cont_msg">
                                        <img
                                          ...
                                          data-tooltip-id="doctor-tooltip"
                                          data-tooltip-content="John clive"
                                        />
                                        <Tooltip
                                          id="doctor-tooltip"
                                          place="top"
