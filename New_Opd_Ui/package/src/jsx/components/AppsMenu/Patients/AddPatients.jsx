...
const AddPatients = () => {
  const [formData, setFormData] = useState({
    ...
    campaignName: "",
    userType: "Doctor",
    modifiedBy: "", // New field for Campaign Name
  });
              ...
              <div className="row">
                ...
                <div className="col-xl-4 mb-3">
                  ...
                  <input
                    ...
                    readOnly // Make it read-only since it's derived from userType
                  />
                </div>
                {/* User Type Selection */}
                <div className="col-xl-4 mb-3">
                  <div className="form-group position-relative">
                    ...
                    <div style={{ position: "relative" }}>
                      ...
                      >
                        ...
                        <option value="Service Caller">Service Caller</option>
                      </select>
                      <i
                        className="fa fa-caret-down"
                        style={{
                          ...
                          pointerEvents: "none", // Icon doesn't block dropdown interaction
                        }}
                      ></i>
                    </div>
                  </div>
