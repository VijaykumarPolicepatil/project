...
const Doctor = () => {
  ...
  <div className="card border-0 pb-0">
    ...
    <div className="card-body">
      <div style={{ height: "450px", overflowY: "auto" }} className="widget-media dz-scroll">
        <ul className="timeline">
          {todayAppointments.map((appointment) => (
            <li key={appointment.id}>
              <div className="timeline-panel">
                <div className="media me-2">
                <Link to="/app-patient-details" className="media-link" onClick={handleAvatarClick}>
                ...
                <div className="media-body">
                  <h5 className="mb-1">
                    {appointment.name} <small className="text-muted">{appointment.time}</small>
                  </h5>
                  <p className="mb-1">General Checkup</p>
                  <Link to="/app-questionnaire" className="btn btn-primary btn-xxs shadow">
                    Reschedule
                  </Link>
