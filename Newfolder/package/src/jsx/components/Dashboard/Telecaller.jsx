...
const Telecaller = () => {
  ...
  const listItem = [
    ...
    },
    {
      ...
      phone: "0987654321",
      disease: "Hypertension, Diabetes",
      date: "11 Jan 2025 , 10:30am",
    },
    // You can add more objects for additional people
  ];
  // Sample data for follow-ups
  const todaysFollowUps = [
    {
      name: "Michael Johnson",
      date: "12 Jan 2025 , 10:30am",
      action: "Follow-up on reschedule",
      nextAction: "Call again on 10-Feb",
    },
    {
      name: "Jane Smith",
      date: "12 Jan 2025 , 12:30pm",
      action: "Lab report review",
      nextAction: "Check patient feedback",
    },
    {
      name: "Alice Brown",
      date: "12 Jan 2025 , 2:30pm",
      action: "Medication review",
      nextAction: "Schedule appointment",
    },
    {
      name: "Tom Wilson",
      date: "12 Jan 2025 , 4:30pm",
      action: "Discuss treatment plan",
      nextAction: "Prepare documents",
    },
    {
      name: "James Anderson",
      date: "12 Jan 2025, 5:00pm",
      action: "Review treatment options",
      nextAction: "Consult with specialists",
    },
    {
      name: "Sophia Wilson",
      date: "13Jan 2025, 4:00pm",
      action: "Follow up on referrals",
      nextAction: "Contact specialists",
    },
  ];

  const tomorrowsFollowUps = [
    {
      name: "David Wilson",
      date: "13 Jan 2025 , 10:30am",
      action: "Routine checkup reminder",
      nextAction: "Confirm with patient",
    },
    {
      name: "Emily Davis",
      date: "13 Jan 2025 , 12:30pm",
      action: "Follow-up on test results",
      nextAction: "Call patient",
    },
    {
      name: "Chris Evans",
      date: "13 Jan 2025 , 4:30pm",
      action: "Vaccination reminder",
      nextAction: "Send reminder email",
    },
    {
      name: "Michael Brown",
      date: "14 Jan 2025, 2:00pm",
      action: "Consult on medication",
      nextAction: "Update prescription",
    },
    {
      name: "Emily Davis",
      date: "15 Jan 2025, 1:00pm",
      action: "Evaluate progress",
      nextAction: "Set new goals",
    },
    {
      name: "Emily Davis",
      date: "15 Jan 2025, 4:00pm",
      action: "Evaluate progress",
      nextAction: "Set new goals",
    },
  ];
  ...
  const upcomingFollowUps = [
    {
      name: "Rahul Mehta",
      date: "22 Feb 2025 , 10:30am",
      action: "Missed appointment reminder",
      nextAction: "No response, try again",
    },
    {
      name: "Sophia Turner",
      date: "22 Feb 2025 , 12:30pm",
      action: "Follow-up on surgery",
      nextAction: "Check recovery status",
    },
    {
      name: "Liam Johnson",
      date: "22 Feb 2025 , 3:30pm",
      action: "Consultation for new symptoms",
      nextAction: "Schedule visit",
    },
    {
      name: "David Smith",
      date: "23 Feb 2025, 12:30pm",
      action: "Discuss lifestyle changes",
      nextAction: "Provide resources",
    },
    {
      name: "Jessica Taylor",
      date: "23 Jan 2025, 2:00pm",
      action: "Plan next steps",
      nextAction: "Follow up on feedback",
    },
    {
      name: "Daniel Martinez",
      date: "23 Jan 2025, 4:00pm",
      action: "Conduct assessment",
      nextAction: "Prepare report",
    },
  ];

  const getTooltipPosition = () => "right";
  // State to hold the window width
  const [width, setWidth] = useState(window.innerWidth);

  // Effect to update the width on window resize
  useEffect(() => {
  ...
  // Function to determine tooltip placement based on width
    ...
    <div>
      ...
      <div className="row mb-3">
        <div className="col-xl-4">
          <Card>
            <Card.Header>
              <Card.Title>Fresh leads</Card.Title>
            </Card.Header>
            <Card.Body style={{ maxHeight: "300px",paddingTop:"0px" ,overflowY: "auto",paddingBottom:"10px" }}>
              {" "}
              ...
              <ListGroup as="ul" variant="flush">
                {listItem.map((item, i) => (
                  ...
                  >
                    <OverlayTrigger
                      trigger="click"
                      placement={getTooltipPlacement()} // Set placement dynamically
                      overlay={
                        <Tooltip
                          id={`tooltip-${i}`}
                          style={{
                        ...
                        >
                          <div>
                            ...
                            <br />{" "}
                            {/* Display date below name with reduced font size */}
                            <span>Gender: {item.gender}</span>
                            <br />
                            <span>Phone: {item.phone}</span>
                            <br />
                            <span>Disease: {item.disease}</span>
                            <br />
                            <Link
                              to={"/app-lead-details"}
        ...
        <div className="col-xl-4">
          <Card>
            <Card.Header>
              <Card.Title>Followup Leads</Card.Title>
            </Card.Header>
            <Card.Body style={{ maxHeight: "300px", paddingTop:"0px" ,overflowY: "auto",paddingBottom:"10px" }}>
              {" "}
              {/* Set max height and enable scrolling */}
      ...
      <div className="row mb-3">
        <div className="col-xl-4">
          <Card>
            <Card.Header>
              <Card.Title>Today's Follow-Ups</Card.Title>
            </Card.Header>
            <Card.Body style={{ maxHeight: "300px", paddingTop:"0px" ,overflowY: "auto",paddingBottom:"10px" }}>
              <ListGroup as="ul" variant="flush">
                {todaysFollowUps.map((item, i) => (
                  <ListGroup.Item
                    as="li"
                    key={i}
                    style={{
                  ...
                  >
                    <OverlayTrigger
                      trigger="click"
                      placement={getTooltipPosition()} // Use the new function name
                      overlay={
                        <Tooltip
                          id={`tooltip-${i}`}
                          style={{
        ...
        <div className="col-xl-4">
          <Card>
            <Card.Header>
              <Card.Title>Tomorrow's Follow-Ups</Card.Title>
            </Card.Header>
            <Card.Body style={{ maxHeight: "300px", paddingTop:"0px" ,overflowY: "auto",paddingBottom:"10px"  }}>
              <ListGroup as="ul" variant="flush">
                {tomorrowsFollowUps.map((item, i) => (
                  <ListGroup.Item
                    as="li"
                    key={i}
                    style={{
        ...
        <div className="col-xl-4">
          <Card>
            <Card.Header>
              <Card.Title>Upcoming Follow-Ups</Card.Title>
            </Card.Header>
            <Card.Body style={{ maxHeight: "300px", paddingTop:"0px" ,overflowY: "auto",paddingBottom:"10px" }}>
              <ListGroup as="ul" variant="flush">
