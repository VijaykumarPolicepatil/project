...
var require_react_apexcharts_min = __commonJS({
  "node_modules/react-apexcharts/dist/react-apexcharts.min.js"(exports) {
    ...
    var _typeof = "function" == typeof Symbol && "symbol" == typeof Symbol.iterator ? function(e2) {
      return typeof e2;
    } : function(e2) {
    ...
    var _extends = Object.assign || function(e2) {
      for (var t2 = 1; t2 < arguments.length; t2++) {
        ...
        for (r2 in n2) Object.prototype.hasOwnProperty.call(n2, r2) && (e2[r2] = n2[r2]);
      }
      return e2;
    };
    var _createClass = /* @__PURE__ */ function() {
      ...
      return function(e2, t2, r2) {
        return t2 && n2(e2.prototype, t2), r2 && n2(e2, r2), e2;
      };
    }();
    var _apexcharts = (init_apexcharts_esm(), __toCommonJS(apexcharts_esm_exports));
    ...
    function _objectWithoutProperties(e2, t2) {
      var r2, n2 = {};
      for (r2 in e2) 0 <= t2.indexOf(r2) || Object.prototype.hasOwnProperty.call(e2, r2) && (n2[r2] = e2[r2]);
      return n2;
    }
    ...
    var Charts = function() {
      ...
      return _inherits(r2, _react.Component), _createClass(r2, [{ key: "render", value: function() {
        var e2 = _objectWithoutProperties(this.props, []);
        ...
        var e2 = this.props, t2 = e2.type, r3 = e2.height, n2 = e2.width, o2 = e2.series, e2 = e2.options;
        return this.extend(e2, { chart: { type: t2, height: r3, width: n2 }, series: o2 });
      } }, { key: "isObject", value: function(e2) {
        return e2 && "object" === (void 0 === e2 ? "undefined" : _typeof(e2)) && !Array.isArray(e2) && null != e2;
      } }, { key: "extend", value: function(t2, r3) {
        var n2 = this, o2 = ("function" != typeof Object.assign && (Object.assign = function(e2) {
          ...
          for (var t3 = Object(e2), r4 = 1; r4 < arguments.length; r4++) {
            var n3 = arguments[r4];
            if (null != n3) for (var o3 in n3) n3.hasOwnProperty(o3) && (t3[o3] = n3[o3]);
          }
          return t3;
        }), Object.assign({}, t2));
        return this.isObject(t2) && this.isObject(r3) && Object.keys(r3).forEach(function(e2) {
          n2.isObject(r3[e2]) && e2 in t2 ? o2[e2] = n2.extend(t2[e2], r3[e2]) : Object.assign(o2, _defineProperty({}, e2, r3[e2]));
        }), o2;
      } }, { key: "componentDidUpdate", value: function(e2) {
        if (!this.chart) return null;
        var t2 = this.props, r3 = t2.options, n2 = t2.series, o2 = t2.height, t2 = t2.width, i2 = JSON.stringify(e2.options), a2 = JSON.stringify(e2.series), r3 = JSON.stringify(r3), s2 = JSON.stringify(n2);
        i2 === r3 && a2 === s2 && o2 === e2.height && t2 === e2.width || (a2 !== s2 && i2 === r3 && o2 === e2.height && t2 === e2.width ? this.chart.updateSeries(n2) : this.chart.updateOptions(this.getConfig()));
