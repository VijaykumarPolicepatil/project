...
import avatar1 from "../../../../src/assets/images/1.jpg";
import avatar2 from "../../../../src/assets//images/avatar/2.jpg";
import scannerIcon from "../../../../src/assets/images/icons8-qr-code-50.png";
...
const Receptionist = () => {
  ...
  const patients = [
    {
      ...
      showCollectButton: true, // Show Collect Payment button
    },
    {
      id: 2,
      avatar: avatar2,
      ...
      reason: "Blood Test",
      showCollectButton: false, // Hide Collect Payment button
    },
    {
      id: 3,
      avatar: avatar2,
      name: "Charlie Green",
      waitingSince: "9:50 AM",
      reason: "Eye Checkup",
      showCollectButton: true, // Show Collect Payment button
    },
    {
    ...
    },
    {
      ...
      reason: "Injury Consultation",
      showCollectButton: false, // Hide Collect Payment button
    },
  ];

  const todayAppointments = [
    { id: 1, name: 'Jogh Doe', time: 'Sat, 22 Feb 2025 10am-11am', doctor: 'Dr. Mehta', avatar: avatar1 },
    { id: 2, name: 'Jane Smith', time: 'Sat, 22 Feb 2025 10am-11am', doctor: 'Dr. Mehta', avatar: 'JS' },
    { id: 3, name: 'Alice Johnson', time: 'Sat, 22 Feb 2025 10am-11am', doctor: 'Dr. Mehta', avatar: avatar2 },
    { id: 4, name: 'Bob Brown', time: 'Sat, 22 Feb 2025 10am-11am', doctor: 'Dr. Mehta', avatar: avatar1 },
  ];
  const tomorrowAppointments = [
    { id: 1, name: 'Jogh Doe', time: 'Sun, 23 Feb 2025 10am-11am', doctor: 'Dr. Mehta', avatar: avatar1 },
    { id: 2, name: 'Jane Smith', time: 'Sun, 23 Feb 2025 10am-11am', doctor: 'Dr. Mehta', avatar: 'JS' },
    { id: 3, name: 'Alice Johnson', time: 'Sun, 23 Feb 2025 10am-11am', doctor: 'Dr. Mehta', avatar: avatar2 },
    { id: 4, name: 'Bob Brown', time: 'Sun, 23 Feb 2025 10am-11am', doctor: 'Dr. Mehta', avatar: avatar1 },
  ];
  ...
  const handleCollectPayment = (patient) => {
  ...
  const handleSubmit = (e) => {
    ...
    console.log(
      `Collected payment of ${amount} via ${paymentMode} for ${selectedPatient.name}`
    );
    setShowModal(false);
    setAmount("");
    ...
    <div>
      <div className="form-head d-flex mb-3 mb-md-4 align-items-start">
        <div className="me-auto d-none d-lg-block">
          <h3 className="text-black font-w600">Welcome to Rohati Ayurved!</h3>
            ...
            <div className="card-body">
              <div className="media align-items-center">
                <div className="media-body">
                  ...
                  <div className="d-flex flex-wrap">
                    <h2 className="fs-40 font-w600 text-white mb-0 me-3">76</h2>
                    <div>
                      <svg
                        width={28}
                        height={19}
        ...
        <div className="col-xl-3 col-xxl-6 col-sm-6">
          <div className="card gradient-bx text-white bg-info rounded">
            <div className="card-body">
              <div className="media align-items-center">
                <div className="media-body">
                  <p className="mb-1">Appointment Books</p>
                  <div className="d-flex flex-wrap">
                    <h2 className="fs-40 font-w600 text-white mb-0 me-3">76</h2>
                    <div>
                      <svg
  ...
  <div className="col-xl-2">
    <Link
      to="/app-add-lead"
      className="btn btn-outline-primary btn-rounded mb-2 d-flex align-items-center justify-content-center"
      style={{ paddingLeft: "15px", paddingRight: "15px", width: "auto" }}
    >
      <i className="lar la-calendar-plus me-2 scale5" />
  ...
  <div className="col-xl-2">
    ...
    >
      ...
      />
      <span className="text-primary">Scan Patient</span>
    </Link>
  </div>
</div>
      ...
      <div className="col-xl-6 col-xxl-6 col-lg-6">
        <div className="card border-0 pb-0">
          <div className="card-header border-0 pb-0">
            <h4 className="card-title">Today's Appointments List</h4>
          </div>
          <div className="card-body">
            <div style={{ height: "450px" }} className="widget-media dz-scroll height370">
              <ul className="timeline">
                {todayAppointments.map(appointment => (
                  <li key={appointment.id}>
                    <div className="timeline-panel">
                      <div className="media me-2">
                        {typeof appointment.avatar === 'string' ? (
                          <div className="media-info">{appointment.avatar}</div>
                        ) : (
                          <img alt="avatar" width="50" src={appointment.avatar} />
                        )}
                      </div>
                      <div className="media-body">
                        <h5 className="mb-1">
                        ...
                        <p className="mb-1">General Checkup</p>
                        <p className="mb-1">Doctor: {appointment.doctor}</p>
                        <Link to="/app-patient-details" className="btn btn-primary btn-xxs shadow">
                          Reschedule
                        </Link>
                        <button onClick={() => handleCancel(appointment.name)} className="btn btn-outline-danger btn-xxs ms-1">
                          Cancel
                        </button>
                      </div>
                    </div>
        ...
        <div className="col-xl-6 col-xxl-6 col-lg-6">
          <div className="card border-0 pb-0">
            <div className="card-header border-0 pb-0">
              <h4 className="card-title">Patient Queue List</h4>
            </div>
            <div className="card-body">
              <div
                id="DZ_W_Todo5"
                className="widget-media dz-scroll height370"
                style={{ height: "450px", overflowY: "auto" }} // This ensures the scroll
              >
                <ul className="timeline">
                  {patients.map((patient) => (
                    <li key={patient.id}>
                      <div className="timeline-panel">
                        <div className="media me-2">
                          <img alt="avatar" width="50" src={patient.avatar} />
                        </div>
                        <div className="media-body">
                          <h5 className="mb-1">
                            {patient.name}{" "}
                          ...
                          <p className="mb-1">Reason: {patient.reason}</p>
                          <div className="d-flex justify-content-between align-items-center">
                            ...
                            {patient.showCollectButton && (
                              <Link
                                to="#"
                                className="btn btn-outline-info btn-xxs ms-1"
                                onClick={() => handleCollectPayment(patient)}
                              >
                                Collect Payment
                              </Link>
                            )}
                  ...
                  <form onSubmit={handleSubmit}>
                    ...
                    <div className="form-group">
                      ...
                      >
                        ...
                        <option value="Bankingcard">Banking Card</option>
        ...
        <div className="card border-0 pb-0">
          <div className="card-header border-0 pb-0">
            <h4 className="card-title">Tomorrow's Appointments List</h4>
          </div>
          <div className="card-body">
            <div style={{ height: "450px" }} className="widget-media dz-scroll height370">
              <ul className="timeline">
